...
type TranslateRequest struct {
	...
	SourceLang    string                 `protobuf:"bytes,2,opt,name=source_lang,json=sourceLang,proto3" json:"source_lang,omitempty"` // e.g. "de"
	TargetLang    string                 `protobuf:"bytes,3,opt,name=target_lang,json=targetLang,proto3" json:"target_lang,omitempty"` // e.g. "es"
...
const file_translation_proto_rawDesc = "" +
	"\n" +
	"\x11translation.proto\x12\vtranslation\"h\n" +
	...
	"\x0ftranslated_text\x18\x01 \x01(\tR\x0etranslatedText2X\n" +
	"\n" +
	"Translator\x12J\n" +
...
var file_translation_proto_depIdxs = []int32{
	0, // 0: translation.Translator.Translate:input_type -> translation.TranslateRequest
	1, // 1: translation.Translator.Translate:output_type -> translation.TranslateResponse
